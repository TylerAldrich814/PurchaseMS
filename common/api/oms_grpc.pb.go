...
type OrderServiceClient interface {
	...
	UpdateOrder(ctx context.Context, in *CreateOrderResponse, opts ...grpc.CallOption) (*CreateOrderResponse, error)
...
func (c *orderServiceClient) UpdateOrder(ctx context.Context, in *CreateOrderResponse, opts ...grpc.CallOption) (*CreateOrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateOrderResponse)
...
type OrderServiceServer interface {
	...
	UpdateOrder(context.Context, *CreateOrderResponse) (*CreateOrderResponse, error)
...
func (UnimplementedOrderServiceServer) UpdateOrder(context.Context, *CreateOrderResponse) (*CreateOrderResponse, error) {
...
func _OrderService_UpdateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).UpdateOrder(ctx, req.(*CreateOrderResponse))
	}
	return interceptor(ctx, in, info, handler)
}
